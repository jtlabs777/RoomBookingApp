...
namespace RoomBookingApp.Api.Tests
{
    public class RoomBookingControllerTests
    {
        ...
        public RoomBookingControllerTests()
        {
            ...
            _request = new RoomBookingRequest(); _result = new RoomBookingResult();
            _roomBookingProcessor.Setup(x => x.BookRoom(_request)).Returns(_result);
        }

        [Theory]
        [InlineData(1, true, typeof(OkObjectResult), BookingResultFlag.Successful)]
        [InlineData(0, false, typeof(BadRequestObjectResult), BookingResultFlag.NotSuccessful)]
